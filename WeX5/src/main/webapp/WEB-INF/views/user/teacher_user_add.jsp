...
<form id="form" action="${__url__}" method="post">
    <table align="center" class="form-table" >
    	<tr>
			...
			<td>
			<input type="text" value="${university.universityName}">
		...
		<tr>
			<td class="tr">学院名称：</td>
			<td>
				<input name="collegeName" class="jq-validatebox" value="${college.collegeName}" type="text" data-options="required:true">
				<input type="hidden" id ="collegea" name="collegeId" value="${college.id}">
			</td>
		</tr>
		<tr>			
			<td class="tr">联系人：</td>
