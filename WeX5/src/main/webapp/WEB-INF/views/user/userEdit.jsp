...
<form id="form" action="${__url__}" method="post">
    <table align="left" class="form-table" style="margin:40px 50px">
    	<tr>
			<td>姓名：</td>
			<td colspan="4" >
				<input class="w200" name="name" class="jq-validatebox"  value='${user.nickName}' type="text" data-options="required:true">
			</td>
		</tr>
		<tr>
			<td>电话号码：</td>
			<td colspan="4" >
				...
				<input type="button" name="sendCode" id="sendCode" class="btn btn-sm btn-success"  value="发送验证码">
			</td>
		</tr>
		<tr>
			<td>验证码：</td>
			<td colspan="4" >
				<input  style="width:150px" name="checkCode" id="checkCode" type="text"  data-options="required:true"  ></input>
			</td>
		</tr>
		<tr>
			<td>邮箱：</td>
		...
		<tr>
			<td>送审码：</td>
			<td colspan="4" >
				<input  style="width:150px" name="sendCode" id="sendCode" value="${user.sendCode}" type="text"  data-options="required:true"  ></input>
			</td>
		</tr>
		<tr>
			<td>职务：</td>
