...
import com.zlzkj.app.mapper.TextMapper;
...
public class TextService {
	...
	public Integer update(Text entity) throws Exception{
		
		return mapper.updateByPrimaryKey(entity);
	}
	
	public Integer save(Text entity) throws Exception{
	...
	public Map<String, Object> getUIGridData(Map<String, Object> where,
		...
		SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Text.class);
		...
		for (Row row:list) {
			...
			row.put("chapterId", chapterService.findById(row.getInt("chapterId")).getTitle());
		}
		//获取总条数
